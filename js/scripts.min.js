...
$(function(){$("#my-menu").mmenu({extensions:["fx-panels-zoom","fx-panels-none","fx-listitems-slide","position-right","theme-dark"],navbar:{title:'<img src="img/logo_bioenergy_bel.svg" alt="Сайт целителя-биоэнергетика">'}});var o=$("#my-menu").data("mmenu");o.bind("open:finish",function(){$(".hamburger").addClass("is-active")}),o.bind("close:finish",function(){$(".hamburger").removeClass("is-active")});var e=$("html, body");$('#my-footer a[href*="#"], #my-menu a[href*="#"]').click(function(){return e.animate({scrollTop:$($.attr(this,"href")).offset().top},400),!1}),$(window).scroll(function(){$(".h6").each(function(){$(this).offset().top<$(window).scrollTop()+350&&($(this).addClass("zoomIn"),this.style.opacity="1")})}),$(window).scroll(function(){$(".punkt").each(function(){$(this).offset().top<$(window).scrollTop()+600&&($(this).addClass("slideInLeft"),this.style.opacity="1")})}),$("select").selectize(),$("form.callback").submit(function(){var o=$(this);return o.find(".success").addClass("active").css("display","flex").hide().fadeIn(),setTimeout(function(){o.find(".success").removeClass("active").fadeOut(),o.trigger("reset")},5e3),!(action.href="https://formspree.io/domovir@outlook.com")}),$(".reviews").owlCarousel({loop:3,items:1,smartSpeed:700,autoHeight:!0}),$(window).scroll(function(){$(this).scrollTop()>$(this).height()?$(".top").addClass("active"):$(".top").removeClass("active")}),$(".top").click(function(){$("html, body").stop().animate({scrollTop:0},"slow","swing")})}),$(window).on("load",function(){$(".preloader").delay(1500).fadeOut("slow")});